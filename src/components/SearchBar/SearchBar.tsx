    ...
    <div className="px-4 py-8 rounded-2xl border border-neutral/5">
      <div className="flex flex-row flex-wrap gap-12 lg:items-end justify-between">
        ...
        <div className="flex justify-between gap-10">
          ...
          <button className="relative inline-flex items-center justify-center p-4 mask-square w-fit h-fit overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group active:scale-95">
